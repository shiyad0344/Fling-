...
//         <h1 class="profile-user-name">{user?.result?.name}</h1>

//         <p class="profile-real-name">{user?.result?.bio}</p>
...
// 				<img src="https://images.unsplash.com/photo-1502630859934-b3b41d18206c?w=500&h=500&fit=crop" class="gallery-image" alt=""></img>
...
// 				<img src="https://images.unsplash.com/photo-1505058707965-09a4469a87e4?w=500&h=500&fit=crop" class="gallery-image" alt=""></img>s
